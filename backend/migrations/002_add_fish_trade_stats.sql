...
WHERE TABLE_SCHEMA = 'fish_market_game'
  AND TABLE_NAME = 'daily_results'
  AND COLUMN_NAME IN ('fish_a_purchased', 'fish_a_sold', 'fish_b_purchased', 'fish_b_sold');

-- Migration 完成
SELECT '✅ Migration 002 完成: 交易量統計欄位已新增' AS status;
